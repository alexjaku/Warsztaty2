...
//STARA METODA CHYBA GORSZA tworzy obiekt do zmiennej, na której robi metodę format podającą datę w formacie pasującym do mojej DB
//$tweetPierwszyDB ->setCreationDate(($date = new DateTime()) -> format('Y-m-d H:i:s')); 
$tweetPierwszyDB ->setCreationDate() ; // -> format('Y-m-d H:i:s');
